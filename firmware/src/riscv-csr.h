...
static inline uint32_t csr_read_write_mcycle(uint32_t new_value) {
 ...
 */
static inline uint32_t csr_read_minstret(void) {
    uint_csr64_t value;        
...
static inline uint32_t csr_read_write_minstret(uint32_t new_value) {
    uint_csr64_t prev_value;
 ...
 */
static inline uint32_t csr_read_mhpmcounter3(void) {
    uint_csr64_t value;        
...
static inline uint32_t csr_read_write_mhpmcounter3(uint32_t new_value) {
    uint_csr64_t prev_value;
